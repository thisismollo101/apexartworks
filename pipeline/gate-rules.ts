...
- Featured food earns the home even in an off-world setting: if the food is load-bearing (the chase object, the payoff), an off-world skin alone does not cut.
...
- ASPIRATIONAL: grounded + brand-safe + premium cinematic quality. This route is WIDE and has NO CONTENT FLOOR: luxury lifestyle, cars, fashion, slick action/thriller energy, sport shot cinematically, even "ordinary life shot like a film trailer" all qualify. Slick + grounded + brand-safe = home.
- Neither → CUT (cut_reason "no-home"). Render words ("ALEXA", "8K", "cinematic") alone don't carry brand: zero indexable hospitality/lifestyle content is a presumptive cut.
